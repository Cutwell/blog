...
## The competition - who is Merl? ![merl]({{ site.baseurl }}/media/minecraft-agent-merlin/merl.webp)
...
![merl UI]({{ site.baseurl }}/media/minecraft-agent-merlin/merl-screenshot.webp)
...
|Merl ![merl]({{ site.baseurl }}/media/minecraft-agent-merlin/merl.webp)|Merlin ![merl]({{ site.baseurl }}/media/minecraft-agent-merlin/merlin.webp)|
|:--:|:--:|
|![merl answering how long a creeper takes to explode]({{ site.baseurl }}/media/minecraft-agent-merlin/merl-creeper-question.webp)|![merlin answering how long a creeper takes to explode]({{ site.baseurl }}/media/minecraft-agent-merlin/merlin-creeper-question.webp)|
...
|:--:|:--:|:--:|
|![furnace recipe]({{ site.baseurl }}/media/minecraft-agent-merlin/furnace-recipe.webp)|![steak recipe]({{ site.baseurl }}/media/minecraft-agent-merlin/steak-recipe.webp)|![netherite axe recipe]({{ site.baseurl }}/media/minecraft-agent-merlin/netherite-axe-recipe.webp)|
...
|:--:|
|![creeper wiki]({{ site.baseurl }}/media/minecraft-agent-merlin/creeper-wiki.webp)|
...
![Merlin in Blockbench]({{ site.baseurl }}/media/minecraft-agent-merlin/blockbench.webp)
